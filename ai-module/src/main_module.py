...
#
# #4. Clean CV and Job_description for semantic analysis
# Cv_cleaned_for_semantic=data_cleaner.clean_text_for_semantic_analysis(Cv_cleaned_for_llm)
# Job_cleaned_for_semantic=data_cleaner.clean_text_for_semantic_analysis(Job_cleaned_for_llm)
#
# #5. Semantic Analysis
# #6. Skills Analysis
# #7. Domain Analysis
# #8. Experience Analysis
# #9. Soft Skills Analysis
# #10. Interview Analysis
# #11. Final Score calculation
# ####################################################################################################

Cv_raw = f"""Personal Info Sibiu, Romania 0750251401 raulraulea@gmail.com Driving License Category B Date of birth 21/05/2003 Links LinkedIn Github Skills Programming Languages: C#, Python, Java, VHDL Web Development: HTML, CSS, JavaScript, PHP Databases: MySQL, PostgreSQL Version Control: Git, GitHub Development Tools: Visual Studio, IntelliJ IDEA, PyCharm Testing: Basic understanding of unit testing (e.g. JUnit) Languages English Romanian French Raul-Constantin Raulea Summary I'm a Computer Science student with practical experience as an intern engineer, eager to apply my programming knowledge to real-world projects and grow through teamwork and problemsolving. Work Experience Junior Engineer, Aumovio (Internship), Sibiu August 2025 - Present - Experience in executing manual and automated testing techniques to ensure software quality. - Skills in using tools such as JIRA, CANoe, DOORS Summer practice, Ropardo, Sibiu July 2025 - Created an Expense Tracker web application for managing your incomes and expenses, with a variety of statistics. - Technologies used: .NET framework(Blazor), Entity Frameworks, PostgreSQL Education Computer Science, University Lucian Blaga of Sibiu 2022 - Present Relevant courses: - Object-Oriented Programming - Software Engineering - Articial Intelligence - Operating Systems - Computer Networks - Data Bases Natural Sciences-Bilingual-English, National College Octavian Goga Sibiu 2018 - 2022 Room Booking Web Application 2024 - 2025 - Full-stack web application where you can book rooms as a student and list apartments as a host, managing CRUD operations, user proles, user groups and administrative moderation. - Engineered using Layered Architecture, SOLID principles, and Role-Based Authentication with Java(Glasssh Server) and MySQL. Information Retrieval Engine 2024 - 2025 - Developed a search and retrieval engine in C# for the Reuters XML news dataset. - Implemented full-text preprocessing (tokenization, lemmatization) and Information Retrieval (IR) techniques to rank articles eciently based on user queries. Didactic Microprocessor Simulator 2024 - 2025 - Designed and implemented a real-time CPU microarchitecture simulator in C# (Windows Forms). - Accurately models the full instruction cycle (fetch-decodeexecute) with visualization of register/memory states, enhancing education in computer architecture. - Java Intermediate - Sololearn - Google AI Essentials - Coursera - ECDL: Computer essentials: Word processing; Spreadsheets; Online essentials; Presentation; Using databases Hobbies - Painting - Padel - Fitness"""
Job_raw =f"""Job Title: Junior Web Developer
About job
🇷🇴 Up to RON 120,000 salary on a full time, permanent employment contract
🌎 Fully remote working anywhere in Romania!
